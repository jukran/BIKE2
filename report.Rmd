...
$Figure$ $5a$ Permuted MCMC samples of model parameters $mu$ and $sigma$ of the log-normal ($mu$, $sigma$)-distribution, and prevalence $q$ of the **hazard**. For each parameter, also the estimated marginal posterior distribution is shown sideways along the y-axis.
...
$Figure$ $5b$ Permuted MCMC samples of model parameters $mu$ and $sigma$ of the log-normal ($mu$, $sigma$)-distribution, and consumption frequency $p$ of the **food**. For each parameter, also the estimated marginal posterior distribution is shown sideways along the y-axis.
