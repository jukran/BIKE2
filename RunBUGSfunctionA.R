...
for(i in 1:nhM){
  ...
  if((input$priorchoice == "sigma_uniform")&(between.user.pvar == 1)){ 
    ...
    if((nhK>0)&(nhM>0)){
      ...
      parameters=c("mucK","mucM","sigcK","sigcM","mus0","Ts0","Ts","logitp0","ppred","Tp","muw","sigw","pM","pK")
    }
    if((nhK>0)&(nhM==0)){
      ...
      parameters=c("mucK","sigcK","mus0","Ts0","Ts","logitp0","ppred","Tp","muw","sigw","pK")
    }
    if((nhK==0)&(nhM>0)){
      ...
      parameters=c("mucM","sigcM","mus0","Ts0","Ts","logitp0","ppred","Tp","muw","sigw","pM")
    }  
  } # end of prior choice
  ...
  if((input$priorchoice == "sigma_uniform")&(between.user.pvar == 0) ){  
    ...
    if((nhK>0)&(nhM>0)){
      ...
      parameters=c("mucK","mucM","sigcK","sigcM","mus0","Ts0","Ts","logitp0","ppred","muw","sigw","pM","pK")
    }
    if((nhK>0)&(nhM==0)){
      inits <- function(){list(muw=0,sigw=1,mucK=initmucK,sigcK=initsigcK,mus=matrix(0,nr,nf),mus0=rep(0,nf),logitp0=rep(0,nf)) }  
      parameters=c("mucK","sigcK","mus0","Ts0","Ts","logitp0","ppred","muw","sigw","pK")
    }
    if((nhK==0)&(nhM>0)){
      ...
      parameters=c("mucM","sigcM","mus0","Ts0","Ts","logitp0","ppred","muw","sigw","pM")
    }  
  } # end of prior choice
